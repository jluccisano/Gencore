package com.gencore.admin.flex.control.command {
    ...
    public class GetUsersCommand extends Command implements IResponder {
        ...
        override public function result(data : Object) : void {
			...
			LucciEventDispatcher.instance.dispatchEvent(new AdminEvent(AdminEvent.GET_USERS_ACK, event.result));
        }
