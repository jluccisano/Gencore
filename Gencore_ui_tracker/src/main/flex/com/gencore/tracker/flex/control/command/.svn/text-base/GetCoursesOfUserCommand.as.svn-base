package com.gencore.tracker.flex.control.command {
    ...
    public class GetCoursesOfUserCommand extends Command implements IResponder {
        ...
        override protected function execute(event : LucciEvent) : void {
            ...
            delegate.getCoursesOfUser(trackerEvent.data);
        ...
        override public function result(data : Object) : void {
            ...
            LucciEventDispatcher.instance.dispatchEvent(new TrackerEvent(TrackerEvent.GET_COURSES_ACK, event.result));
        }
