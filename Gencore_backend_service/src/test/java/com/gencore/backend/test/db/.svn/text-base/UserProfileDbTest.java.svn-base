...
public class UserProfileDbTest extends BaseTest {
    ...
    private IDataSet getDataSet() throws Exception {
        ...
        IDataSet dataSet = builder.build(new File("src/test/resources/com/gencore/backend/test/resources/dataset/UserProfileDataSet.xml"));
        return dataSet;
    }
